					...
					<form action="school/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="SCHOOL_NAME" id="SCHOOL_NAME" value="${pd.SCHOOL_NAME}" maxlength="30" placeholder="这里输入学校名称" title="学校名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">学校地址:</td>
								<td><input type="text" name="SCHOOL_ADDRESS" id="SCHOOL_ADDRESS" value="${pd.SCHOOL_ADDRESS}" maxlength="100" placeholder="这里输入学校地址" title="学校地址" style="width:98%;"/></td>
							</tr>
							<tr>
