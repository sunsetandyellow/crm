package com.fh.controller.student.student;
...
import com.fh.service.school.school.SchoolManager;
import com.fh.service.student.student.StudentManager;
...
public class StudentController extends BaseController {
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> varSchoolList = schoolService.listAll(pd);
		mv.addObject("varSchoolList", varSchoolList);
		mv.setViewName("student/student/student_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).getString("SCHOOL_NAME"));	    //3
			varList.add(vpd);
		}
